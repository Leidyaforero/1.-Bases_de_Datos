...
CREATE TABLE Detalle_Venta (
    ...
    CONSTRAINT FK_Detalle_Venta_Venta FOREIGN KEY (venta_id) REFERENCES Ventas(id_venta),
    CONSTRAINT FK_Detalle_Venta_Cultivo FOREIGN KEY (cultivo_id) REFERENCES Cultivos(id_cultivo)
);
...
CREATE TABLE Compras (
    ...
    CONSTRAINT FK_Compra_Insumo FOREIGN KEY (insumo_id) REFERENCES Insumos(id_insumo)
);
...
CREATE TABLE Detalle_Cultivo (
    ...
    CONSTRAINT FK_Detalle_Cultivo_Cultivo FOREIGN KEY (cultivo_id) REFERENCES Cultivos(id_cultivo),
    CONSTRAINT FK_Detalle_Cultivo_Insumo FOREIGN KEY (insumo_id) REFERENCES Insumos(id_insumo)
);
