...
def migrate_data():
    ...
    print("Migrando tabla Cultivos...")
    migrate_table(
        mysql_table='Cultivos',
        sqlserver_table='Cultivos',
    ...
    print("Migrando tabla Insumos...")
    migrate_table(
        mysql_table='Insumos',
        sqlserver_table='Insumos',
    ...
    migrate_table(
        ...
        sqlserver_table='Clientes',
        columns=['id_cliente', 'nombre', 'correo', 'telefono'],
        use_identity_insert=True
    )

    # Migración de la tabla Venta
    print("Migrando tabla Ventas...")
    migrate_table(
        mysql_table='Ventas',
        sqlserver_table='Ventas',
